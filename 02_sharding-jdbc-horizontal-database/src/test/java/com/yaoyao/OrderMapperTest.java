...
//            order.setUserId(1);//入m2:order_db_2
            order.setUserId(4);//入m1:order_db_1
    ...
    public void testFindByOrderIdAndUserId() {
        Long orderId = 448616158661181441L;
        Long userId = 1L;
        List<Order> allList = orderMapper.findByOrderIdAndUserId(orderId, userId);
        System.out.println("allList:" + JSONObject.toJSONString(allList));
    }
